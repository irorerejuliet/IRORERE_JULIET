...
const socialLinks = [
  { icon: "GitHub", href: "https://github.com/irorerejuliet", label: "GitHub" },
  {
    icon: "LinkedIn",
  ...
  { icon: "Email", href: "https://x.com/irorerejuliet1?s=21", label: "Email" },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-2xl font-bold text-accent">IRORERE JULIET</p>
